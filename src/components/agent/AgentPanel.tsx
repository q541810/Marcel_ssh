  ...
  return (
    <div className="flex flex-col h-full bg-zinc-900">
      ...
      <div className="p-3 border-t border-zinc-800">
        <div className="relative flex items-center rounded-lg bg-zinc-800 border border-zinc-700">
              ...
              {sessionConversations.map((conv) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className={`truncate font-medium ${isActive ? 'text-zinc-100' : 'text-zinc-400 hover:text-zinc-100'}`}>
                        {conv.title}
                      </div>
