...
export default function AgentMessage({ message }: Props) {
  ...
  if (message.role === 'assistant' && !message.isLoading && message.content === '' && !message.reasoningContent && !message.toolCall) {
    return null;
  }
      ...
      <div className="max-w-[90%]">
        ...
        {hasReasoning && (
          <div className="mb-2">
            ...
            {thinkingExpanded && (
              <div className={`mt-1.5 pl-4 border-l-2 border-zinc-700 ${THINKING_MARKDOWN_CLASS}`}>
        ...
        {message.isLoading ? (
          ...
          hasReasoning ? null : <div className="text-sm text-zinc-500 italic">（无内容）</div>
        ) : (
