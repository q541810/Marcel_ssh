...
impl McpClient {
    ...
    pub async fn initialize(&self, url: &str, headers: &HashMap<String, String>) -> Result<(), AppError> {
    ...
    pub async fn list_tools(&self, url: &str, headers: &HashMap<String, String>) -> Result<Vec<McpToolInfo>, AppError> {
